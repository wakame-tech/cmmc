...
typedef enum { /* operation codes of PL/0 code */
    O_LIT, O_OPR, O_LOD,
    O_STO, O_CAL, O_INT,
    O_JMP, O_JPC, O_CSP,
    O_LAB, O_BAD, O_RET
...
typedef enum { /* sub-operations of arithmetic operation etc. */
    P_RET, P_NEG, P_ADD, P_SUB, P_MUL, P_DIV, P_ODD, P_MOD,
    P_EQ, P_NE, P_LT, P_GE, P_GT, P_LE
} oprcode;
    
typedef enum { RDI, WRI, WRL } cspcode; /* sub-operations of I/O operation */
